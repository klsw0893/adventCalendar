  ...
  return (
    <div className={styles.overlay}>
      <div className={styles.popup}>
        ...
        <iframe src="https://wordwall.net/hu/embed/0ef032089be14e778f2963c01bcf31d0?themeId=6&templateId=5&fontStackId=0" width="100%" height="85%" frameborder="0" allowfullscreen></iframe>
